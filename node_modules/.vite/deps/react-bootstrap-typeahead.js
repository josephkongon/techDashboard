...
import {
  ...
  _slicedToArray
} from "./chunk-L2SHZ2LO.js";
import {
  autoUpdate
} from "./chunk-AUIKCYVB.js";
import {
  require_browser,
  require_warning,
  useEventCallback
} from "./chunk-DINXBRTN.js";
import "./chunk-Q5DOROEY.js";
import {
  require_prop_types
} from "./chunk-2T6SICAE.js";
...
} from "./chunk-2QLNHAXD.js";
import {
  require_classnames
} from "./chunk-CCL26HJW.js";
import "./chunk-N5G3ITPM.js";
import {
  require_react
...
function isSizeLarge(size2) {
  return size2 === "lg";
}
function isSizeSmall(size2) {
  return size2 === "sm";
}
...
function propsWithBsClassName(_ref) {
  var className = _ref.className, isInvalid = _ref.isInvalid, isValid = _ref.isValid, size2 = _ref.size, props = _objectWithoutProperties(_ref, _excluded2);
  return _objectSpread2(_objectSpread2({}, props), {}, {
    className: (0, import_classnames2.default)("form-control", "rbt-input", {
      "form-control-lg": isSizeLarge(size2),
      "form-control-sm": isSizeSmall(size2),
...
var ClearButton = function ClearButton2(_ref) {
  var className = _ref.className, _ref$label = _ref.label, label = _ref$label === void 0 ? "Clear" : _ref$label, _onClick = _ref.onClick, _onKeyDown = _ref.onKeyDown, size2 = _ref.size, props = _objectWithoutProperties(_ref, _excluded5);
  return import_react7.default.createElement("button", _extends({}, props, {
    ...
    className: (0, import_classnames3.default)("close", "btn-close", "rbt-close", {
      "rbt-close-lg": isSizeLarge(size2),
      "rbt-close-sm": isSizeSmall(size2)
    }, className),
...
function useOverlay(referenceElement, options) {
  var _useState = (0, import_react9.useState)(null), _useState2 = _slicedToArray(_useState, 2), floatingElement = _useState2[0], attachRef = _useState2[1];
...
// node_modules/react-bootstrap-typeahead/es/components/RootClose/useClickOutside.js
...
function useClickOutside(ref) {
  var onClickOutside = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : noop;
  var _ref = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, disabled = _ref.disabled, _ref$clickTrigger = _ref.clickTrigger, clickTrigger = _ref$clickTrigger === void 0 ? "click" : _ref$clickTrigger;
  var preventMouseClickOutsideRef = (0, import_react10.useRef)(false);
  var waitingForTrigger = (0, import_react10.useRef)(false);
  var handleMouseCapture = (0, import_react10.useCallback)(function(e3) {
    ...
    preventMouseClickOutsideRef.current = !currentTarget || isModifiedEvent(e3) || !isLeftClickEvent(e3) || !!currentTarget.contains(e3.target) || waitingForTrigger.current;
    waitingForTrigger.current = false;
  }, [ref]);
  var handleInitialMouse = useEventCallback(function(e3) {
    var currentTarget = ref.current;
    if (currentTarget !== null && currentTarget !== void 0 && currentTarget.contains(e3.target)) {
  ...
  (0, import_react10.useEffect)(function() {
    ...
    if (InitialTriggerEvents[clickTrigger]) {
      ...
      removeInitialTriggerListener = function removeInitialTriggerListener2() {
        doc.removeEventListener(InitialTriggerEvents[clickTrigger], handleInitialMouse);
      };
    }
    var handleMouseTrigger = function handleMouseTrigger2(e3) {
      if (e3 === currentEvent) {
        currentEvent = void 0;
        return;
      }
...
function useRootClose(onRootClose, options) {
  ...
  useClickOutside_default(ref, onClose, options);
  ...
  (0, import_react11.useEffect)(function() {
    var _ref$current;
    if (options.disabled || ref == null) return void 0;
    var doc = ((_ref$current = ref.current) === null || _ref$current === void 0 ? void 0 : _ref$current.ownerDocument) || document;
    var currentEvent = (doc.defaultView || window).event;
    var onKeyUp = function onKeyUp2(e3) {
      if (e3 === currentEvent) {
        currentEvent = void 0;
        return;
      }
...
function RootClose(_ref) {
  ...
  var rootRef = useRootClose_default(onRootClose, props);
...
function useToken(_ref) {
  ...
  var attachRef = useRootClose_default(handleBlur, _objectSpread7(_objectSpread7({}, props), {}, {
    disabled: !active
  }));
  return {
    active,
...
var TypeaheadComponent = function(_React$Component) {
  ...
  function TypeaheadComponent2() {
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderInput", function(inputProps, props) {
      var _this$props = _this.props, isInvalid = _this$props.isInvalid, isValid = _this$props.isValid, multiple = _this$props.multiple, renderInput = _this$props.renderInput, renderToken = _this$props.renderToken, size2 = _this$props.size;
    ...
    _defineProperty(_assertThisInitialized(_this), "_renderAux", function(_ref) {
      ...
      var _this$props3 = _this.props, clearButton = _this$props3.clearButton, disabled = _this$props3.disabled, isLoading = _this$props3.isLoading, size2 = _this$props3.size;
      var content;
      if (isLoading) {
